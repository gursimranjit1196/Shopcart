...
<div id="main_content">
    <div id="menu_tab">
      ...
      <p style="font-size: 20px;font-style: italic; float: right; margin-top: 20px;color: white;">USERNAME: <%=session.getAttribute("user") %> </p>  
...
<!-- end of center content -->
     ...
     {	 
    	 String xx=request.getParameter("var4");
    	 System.out.println(xx);
    	 
    	 %>
    	 <div style="float: right;margin-right: 0%;font-size: 20px;height:35px;">
    	 <a href="cart2.jsp" type="hyperlink">FAVOURITES</a>
...
<!-- <font size="9"> -->
 ...
 <tr><td>TO:</td><td>        <input type="text" name="t1" id="t1" value=<%= request.getParameter("var1") %>><br><br></td></tr>
 
 <tr><td>Subject:    </td><td> <input type="text" name="t2" id="t2" value=<%= request.getParameter("var2") %>></td></tr><br><br>
