	...
	while(rs.next())
	{
		...
		<div class="prod_alnmt"> 
	      ...
	      <div class="center_prods_box" >
	        <div class="product_title" style="font-size: 25px;text-decoration: underline;"><%=rs.getString(1) %>       </div>
	        <div class="product_img"><img  class="fancybox"  src="sellerimage/<%=rs.getString(10) %>" data-big="sellerimage/<%=rs.getString(10) %>" height="173px" width="173px" border="0" /></div>
